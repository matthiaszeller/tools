...
# SOURCE: https://askubuntu.com/a/702302/1056337
# from https://askubuntu.com/questions/702071/move-windows-to-specific-screens-using-the-command-line

# Description: Use wmctrl, xrandr and xdotool to move a program to a specific monitor
# (Ubuntu 18.04: must install wmctrl and xdotool)

# Usage: python move_win_class.py <CLASS> <target_screen>
# Example: python move_win_class.py gnome-terminal VGA-1
# Run xrandr in the terminal to see the "screen names"
